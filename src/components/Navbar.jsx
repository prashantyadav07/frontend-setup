...
export default function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 right-0 z-50 flex flex-col justify-start px-3 sm:px-4 pointer-events-none pt-6 sm:pt-8"
    >
      {/* Background Dim Smoke Gradient spanning the top */}
      <div className="absolute top-0 left-0 right-0 h-40 bg-gradient-to-b from-black/60 via-black/20 to-transparent pointer-events-none -z-10" />

      <div className="w-full flex justify-center">
        <div className={`
          relative overflow-hidden bg-[#F2F0E9]/85 backdrop-blur-2xl shadow-[0_15px_40px_rgba(0,0,0,0.2)] border border-white/10 rounded-2xl px-5 sm:px-8 py-3 sm:py-4 transition-all duration-500 pointer-events-auto w-[96%] sm:w-[95%]
          ${scrolled ? 'max-w-7xl' : 'max-w-[1400px]'}
        `}>

          {/* Reddish Gradient Bottom Border */}
          <div className="absolute bottom-0 left-0 right-0 h-[3px] bg-gradient-to-r from-transparent via-red-600/80 to-transparent" />
                ...
                <div className="p-6 flex flex-col h-full">
                  ...
                  <div className="flex items-center justify-between mb-10">
                    <div className="flex flex-col items-start leading-none gap-[4px]">
                      ...
                      <span className="text-[15px] font-semibold tracking-[0.2em] uppercase text-black">Defence Garden Colony</span>
                    </div>
